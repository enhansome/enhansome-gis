...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 317,385 | 🐛 18 | 🌐 Python | 📅 2026-08-25.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,498 | 🐛 388 | 🌐 TypeScript | 📅 2026-08-31 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [three-geo](https://github.com/w3reality/three-geo) ⭐ 1,404 | 🐛 28 | 🌐 JavaScript | 📅 2025-02-25 - Is a three.js based geographic visualization library
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,720 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,314 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,314 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,174 | 🐛 578 | 🌐 C++ | 📅 2026-08-31 - A fork of mapbox-gl-native after licensing change
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,594 | 🐛 773 | 🌐 C++ | 📅 2026-08-31 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,138 | 🐛 938 | 🌐 C++ | 📅 2026-08-26 - Open Source Routing Engine for OpenStreetMap.
...
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,541 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-31 - WebGL2 powered geospatial visualization layers.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,171 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-31 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,541 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-31 - High-scale spatial rendering in Python, powered by deck.gl.
...
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,833 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,496 | 🐛 237 | 🌐 Python | 📅 2026-08-20 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,566 | 🐛 156 | 🌐 Python | 📅 2026-08-30 - A library for reads and writes geospatial raster data)
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,894 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,920 | 🐛 124 | 🌐 Rust | 📅 2026-08-31 - Geospatial primitives and algorithms for Rust.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,274 | 🐛 2 | 📅 2026-08-31 - most Geospatial Library content come from this ropository.

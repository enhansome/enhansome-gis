...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,066 | 🐛 19 | 🌐 Python | 📅 2026-09-15.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,663 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-16 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,210 | 🐛 611 | 🌐 C++ | 📅 2026-09-16 - A fork of mapbox-gl-native after licensing change
...
* [H3](https://github.com/uber/h3) ⭐ 6,538 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,218 | 🐛 937 | 🌐 C++ | 📅 2026-09-16 - Open Source Routing Engine for OpenStreetMap.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,742 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-09-16 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,594 | 🐛 534 | 🌐 TypeScript | 📅 2026-09-16 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,662 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,373 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,594 | 🐛 534 | 🌐 TypeScript | 📅 2026-09-16 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,385 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,508 | 🐛 228 | 🌐 Python | 📅 2026-09-15 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,917 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,226 | 🐛 52 | 🌐 Python | 📅 2026-09-16 - python interface to PROJ4 library for cartographic transformations
...
* [Rtree](https://github.com/Toblerity/Rtree) ⭐ 683 | 🐛 28 | 🌐 Python | 📅 2026-09-16 - A wrapper of libspatialindex providing spatial indexing features for Python GIS.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 655 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,526 | 🐛 70 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,290 | 🐛 0 | 📅 2026-09-16 - most Geospatial Library content come from this ropository.

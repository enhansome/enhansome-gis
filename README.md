...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,507 | 🐛 23 | 🌐 Python | 📅 2026-09-15.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,691 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* **Android**
  ...
  * [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 495 | 🐛 560 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
  * [NextGIS Android SDK](https://github.com/nextgis/android_maplib) ⭐ 29 | 🐛 2 | 🌐 Java | 📅 2026-09-18 - An open source library for Android geo applications.
...
* **Cross-Platform**
  * [Red Grid MGRS](https://github.com/RedGridTactical/RedGridMGRS) ⭐ 21 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-09 - Open-source DAGR-class military GPS navigator with live MGRS coordinates, magnetic declination, waypoints, bearing & distance, and tactical tools. Built with React Native/Expo for iOS and Android.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,215 | 🐛 617 | 🌐 C++ | 📅 2026-09-18 - A fork of mapbox-gl-native after licensing change
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,725 | 🐛 86 | 🌐 C++ | 📅 2026-09-15 - Computational geometry and spatial indexing on the sphere.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,716 | 🐛 54 | 🌐 C# | 📅 2026-09-18 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 115 | 🐛 35 | 🌐 Fortran | 📅 2026-09-18 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,750 | 🐛 1,658 | 🌐 JavaScript | 📅 2026-09-18 - An open-source JavaScript library for world-class 3D globes and maps.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,180 | 🐛 125 | 🌐 JavaScript | 📅 2026-09-09 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [osm-static-maps](https://github.com/jperelli/osm-static-maps) ⭐ 180 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-06 - Openstreetmap static maps is a nodejs lib, CLI and server to create map images based on tiles + layers. Inspired on google static map service.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,597 | 🐛 543 | 🌐 TypeScript | 📅 2026-09-18 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,395 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,845 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,511 | 🐛 230 | 🌐 Python | 📅 2026-09-18 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,027 | 🐛 59 | 🌐 Python | 📅 2026-09-17 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,918 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,925 | 🐛 53 | 🌐 Rust | 📅 2026-09-18 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,938 | 🐛 137 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 38 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-18 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,292 | 🐛 21 | 🌐 Python | 📅 2026-09-15.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 495 | 🐛 560 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,675 | 🐛 270 | 🌐 TypeScript | 📅 2026-09-17 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,333 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,333 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,213 | 🐛 619 | 🌐 C++ | 📅 2026-09-17 - A fork of mapbox-gl-native after licensing change
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,747 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-09-17 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,596 | 🐛 539 | 🌐 TypeScript | 📅 2026-09-17 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,664 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [gcoord](https://github.com/hujiulong/gcoord) ⭐ 3,321 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-23 - 地理坐标系转换工具，支持WGS84/GCJ02/BD09等常用坐标系互转.
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,916 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - A Vue 2.x & Vue 3.x based component library of CesiumJS for GISer.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 13 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-17 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,596 | 🐛 539 | 🌐 TypeScript | 📅 2026-09-17 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,390 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,510 | 🐛 230 | 🌐 Python | 📅 2026-09-17 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,026 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,576 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - A library for reads and writes geospatial raster data)
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,227 | 🐛 52 | 🌐 Python | 📅 2026-09-16 - python interface to PROJ4 library for cartographic transformations
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 972 | 🐛 80 | 🌐 Python | 📅 2026-09-09 - Raster-Based Spatial Analysis in Python.
...
* [Rtree](https://github.com/Toblerity/Rtree) ⭐ 683 | 🐛 29 | 🌐 Python | 📅 2026-09-16 - A wrapper of libspatialindex providing spatial indexing features for Python GIS.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 656 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [morecantile](https://github.com/developmentseed/morecantile) ⭐ 161 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Construct and use map tile grids (a.k.a TileMatrixSet / TMS).
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,447 | 🐛 65 | 🌐 R | 📅 2026-09-16 - Simple Features for R
...
* [awesome-satellite-imagery-datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived - List of satellite imagery datasets with annotations for computer vision and deep learning.
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,630 | 🐛 3 | 📅 2026-08-10 - awesome implementations of the Mapbox Vector Tile specification.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 37 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,291 | 🐛 2 | 📅 2026-09-16 - most Geospatial Library content come from this ropository.

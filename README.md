...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,126 | 🐛 21 | 🌐 Python | 📅 2026-09-20.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,375 | 🐛 244 | 🌐 Scala | 📅 2026-09-14 - A geographic data processing engine for high performance applications that uses Spark to work with raster data.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,714 | 🐛 285 | 🌐 TypeScript | 📅 2026-09-21 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [three-geo](https://github.com/w3reality/three-geo) ⭐ 1,413 | 🐛 28 | 🌐 JavaScript | 📅 2025-02-25 - Is a three.js based geographic visualization library
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,340 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,340 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,219 | 🐛 608 | 🌐 C++ | 📅 2026-09-21 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,661 | 🐛 78 | 🌐 C | 📅 2026-09-21 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,549 | 🐛 168 | 🌐 C | 📅 2026-09-18 - Hexagonal hierarchical geospatial indexing system.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,760 | 🐛 1,662 | 🌐 JavaScript | 📅 2026-09-18 - An open-source JavaScript library for world-class 3D globes and maps.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,180 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-21 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
* [gcoord](https://github.com/hujiulong/gcoord) ⭐ 3,323 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-23 - 地理坐标系转换工具，支持WGS84/GCJ02/BD09等常用坐标系互转.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,603 | 🐛 534 | 🌐 TypeScript | 📅 2026-09-21 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,405 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,851 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,512 | 🐛 229 | 🌐 Python | 📅 2026-09-21 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,923 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,934 | 🐛 47 | 🌐 Rust | 📅 2026-09-21 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,293 | 🐛 4 | 📅 2026-09-19 - most Geospatial Library content come from this ropository.

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 314,442 | 🐛 16 | 🌐 Python | 📅 2026-08-16.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 492 | 🐛 553 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,363 | 🐛 389 | 🌐 TypeScript | 📅 2026-08-17 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,528 | 🐛 117 | 🌐 HTML | 📅 2026-08-10 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [Tangram](https://github.com/tangrams/tangram) ⭐ 2,333 | 🐛 66 | 🌐 JavaScript | 📅 2026-02-08 - A JavaScript library for rendering 2D & 3D maps live in a web browser with WebGL
...
* **Cross-Platform**
  * [Red Grid MGRS](https://github.com/RedGridTactical/RedGridMGRS) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-16 - Open-source DAGR-class military GPS navigator with live MGRS coordinates, magnetic declination, waypoints, bearing & distance, and tactical tools. Built with React Native/Expo for iOS and Android.
...
* [deep learning object detection](https://github.com/hoya012/deep_learning_object_detection) ⭐ 11,387 | 🐛 6 | 🌐 Python | 📅 2024-02-12 - A paper list of object detection using deep learning.
* [Awesome Semantic Segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,851 | 🐛 17 | 📅 2021-05-08 - A code list of semantic segmentation.
...
* [aviary](https://github.com/geospaitial-lab/aviary) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Pythonic Framework for AI Inference on Geospatial Data.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,143 | 🐛 566 | 🌐 C++ | 📅 2026-08-17 - A fork of mapbox-gl-native after licensing change
...
* [H3](https://github.com/uber/h3) ⭐ 6,467 | 🐛 166 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,871 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,583 | 🐛 762 | 🌐 C++ | 📅 2026-08-17 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,382 | 🐛 115 | 🌐 Python | 📅 2026-08-13 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,075 | 🐛 932 | 🌐 C++ | 📅 2026-08-17 - Open Source Routing Engine for OpenStreetMap.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,126 | 🐛 18 | 🌐 Go | 📅 2026-03-30 - Package orb defines a set of types for working with 2d geo and planar/projected geometric data in Golang.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,634 | 🐛 243 | 🌐 Java | 📅 2026-08-15 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,574 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-15 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,452 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-16 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,550 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [gcoord](https://github.com/hujiulong/gcoord) ⭐ 3,312 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-23 - 地理坐标系转换工具，支持WGS84/GCJ02/BD09等常用坐标系互转.
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,909 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - A Vue 2.x & Vue 3.x based component library of CesiumJS for GISer.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,452 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-16 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,298 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,813 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,487 | 🐛 237 | 🌐 Python | 📅 2026-08-12 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,561 | 🐛 159 | 🌐 Python | 📅 2026-08-14 - A library for reads and writes geospatial raster data)
* [felicette](https://github.com/plant99/felicette) ⚠️ Archived - Satellite imagery for dummies.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,440 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 962 | 🐛 85 | 🌐 Python | 📅 2026-08-17 - Raster-Based Spatial Analysis in Python.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 598 | 🐛 0 | 🌐 Python | 📅 2026-07-27 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 349 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - Easily visualize large geospatial images with ipyleaflet or folium in Jupyter or in a web browser with CesiumJS.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,834 | 🐛 80 | 🌐 Rust | 📅 2026-08-15 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,912 | 🐛 117 | 🌐 Rust | 📅 2026-08-13 - Geospatial primitives and algorithms for Rust.
...
* [rust-proj](https://github.com/georust/rust-proj) ⭐ 183 | 🐛 38 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 31 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-17 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,479 | 🐛 56 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,253 | 🐛 4 | 📅 2026-08-12 - most Geospatial Library content come from this ropository.

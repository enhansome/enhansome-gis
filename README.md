...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,825 | 🐛 18 | 🌐 Python | 📅 2026-09-15.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 243 | 🌐 Scala | 📅 2026-09-14 - A geographic data processing engine for high performance applications that uses Spark to work with raster data.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,652 | 🐛 287 | 🌐 TypeScript | 📅 2026-09-15 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,536 | 🐛 121 | 🌐 HTML | 📅 2026-09-14 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [Mapv](https://github.com/huiyan-fe/mapv/) ⭐ 2,609 | 🐛 136 | 🌐 JavaScript | 📅 2026-06-10 - A library of geography visualization
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,332 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,332 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,208 | 🐛 611 | 🌐 C++ | 📅 2026-09-15 - A fork of mapbox-gl-native after licensing change
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,605 | 🐛 777 | 🌐 C++ | 📅 2026-09-15 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,209 | 🐛 943 | 🌐 C++ | 📅 2026-09-15 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,724 | 🐛 85 | 🌐 C++ | 📅 2026-09-15 - Computational geometry and spatial indexing on the sphere.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,131 | 🐛 20 | 🌐 Go | 📅 2026-03-30 - Package orb defines a set of types for working with 2d geo and planar/projected geometric data in Golang.
...
* [Photon](https://github.com/komoot/photon) ⭐ 3,054 | 🐛 45 | 🌐 Java | 📅 2026-09-14 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,732 | 🐛 1,658 | 🌐 JavaScript | 📅 2026-09-15 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,593 | 🐛 532 | 🌐 TypeScript | 📅 2026-09-15 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,660 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,947 | 🐛 14 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,179 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-09 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 12 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-15 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,593 | 🐛 532 | 🌐 TypeScript | 📅 2026-09-15 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,380 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,844 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,508 | 🐛 227 | 🌐 Python | 📅 2026-09-15 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,575 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - A library for reads and writes geospatial raster data)
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,916 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,225 | 🐛 53 | 🌐 Python | 📅 2026-09-14 - python interface to PROJ4 library for cartographic transformations
...
* [Rtree](https://github.com/Toblerity/Rtree) ⭐ 683 | 🐛 28 | 🌐 Python | 📅 2026-09-15 - A wrapper of libspatialindex providing spatial indexing features for Python GIS.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 653 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 594 | 🐛 21 | 🌐 Python | 📅 2026-09-15 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,936 | 🐛 137 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
...
* [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 450 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
...
* [rust-wkt](https://github.com/georust/rust-wkt) ⭐ 57 | 🐛 18 | 🌐 Rust | 📅 2026-09-10 - Rust read/write support for well-known text (WKT).
...
* [Awesome-GEE](https://github.com/giswqs/Awesome-GEE) ⭐ 1,244 | 🐛 0 | 📅 2026-08-31 - A curated list of Google Earth Engine resources.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 37 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,289 | 🐛 0 | 📅 2026-09-11 - most Geospatial Library content come from this ropository.

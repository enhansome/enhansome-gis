...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 315,105 | 🐛 17 | 🌐 Python | 📅 2026-08-16.
...
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,531 | 🐛 117 | 🌐 HTML | 📅 2026-08-18 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,154 | 🐛 565 | 🌐 C++ | 📅 2026-08-20 - A fork of mapbox-gl-native after licensing change
...
* [H3](https://github.com/uber/h3) ⭐ 6,475 | 🐛 166 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,584 | 🐛 764 | 🌐 C++ | 📅 2026-08-20 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,387 | 🐛 116 | 🌐 Python | 📅 2026-08-20 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,094 | 🐛 928 | 🌐 C++ | 📅 2026-08-20 - Open Source Routing Engine for OpenStreetMap.
...
* [Photon](https://github.com/komoot/photon) ⭐ 2,997 | 🐛 44 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,588 | 🐛 1,647 | 🌐 JavaScript | 📅 2026-08-20 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,491 | 🐛 479 | 🌐 TypeScript | 📅 2026-08-20 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,557 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,165 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-20 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,491 | 🐛 479 | 🌐 TypeScript | 📅 2026-08-20 - High-scale spatial rendering in Python, powered by deck.gl.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,488 | 🐛 236 | 🌐 Python | 📅 2026-08-20 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,561 | 🐛 156 | 🌐 Python | 📅 2026-08-20 - A library for reads and writes geospatial raster data)
* [felicette](https://github.com/plant99/felicette) ⚠️ Archived - Satellite imagery for dummies.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,706 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,222 | 🐛 58 | 🌐 Python | 📅 2026-08-11 - python interface to PROJ4 library for cartographic transformations
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 964 | 🐛 81 | 🌐 Python | 📅 2026-08-18 - Raster-Based Spatial Analysis in Python.
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,915 | 🐛 120 | 🌐 Rust | 📅 2026-08-20 - Geospatial primitives and algorithms for Rust.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,305 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,817 | 🐛 10 | 📅 2026-05-26 - Curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,490 | 🐛 58 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,263 | 🐛 0 | 📅 2026-08-20 - most Geospatial Library content come from this ropository.

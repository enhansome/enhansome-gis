...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 317,988 | 🐛 18 | 🌐 Python | 📅 2026-09-01.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 494 | 🐛 557 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,526 | 🐛 387 | 🌐 TypeScript | 📅 2026-09-03 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,534 | 🐛 118 | 🌐 HTML | 📅 2026-08-25 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,316 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,316 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,187 | 🐛 586 | 🌐 C++ | 📅 2026-09-03 - A fork of mapbox-gl-native after licensing change
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,596 | 🐛 778 | 🌐 C++ | 📅 2026-09-03 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,157 | 🐛 942 | 🌐 C++ | 📅 2026-09-02 - Open Source Routing Engine for OpenStreetMap.
...
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,798 | 🐛 59 | 🌐 C | 📅 2026-09-03 - A free open source C++ geospatial toolkit.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,649 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-09-03 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,552 | 🐛 488 | 🌐 TypeScript | 📅 2026-09-03 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,594 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [gcoord](https://github.com/hujiulong/gcoord) ⭐ 3,318 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-23 - 地理坐标系转换工具，支持WGS84/GCJ02/BD09等常用坐标系互转.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,552 | 🐛 488 | 🌐 TypeScript | 📅 2026-09-03 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,344 | 🐛 320 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,497 | 🐛 238 | 🌐 Python | 📅 2026-08-20 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,901 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 57 | 🌐 Python | 📅 2026-09-02 - python interface to PROJ4 library for cartographic transformations
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 618 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,888 | 🐛 60 | 🌐 Rust | 📅 2026-09-03 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,923 | 🐛 130 | 🌐 Rust | 📅 2026-09-01 - Geospatial primitives and algorithms for Rust.
...
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,381 | 🐛 7 | 🌐 HTML | 📅 2026-05-13 - curated list of awesome tools, tutorials, code, helpful projects, links, stuff about Earth Observation and Geospatial stuff!
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,511 | 🐛 67 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,276 | 🐛 1 | 📅 2026-09-03 - most Geospatial Library content come from this ropository.

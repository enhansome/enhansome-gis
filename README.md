...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 318,251 | 🐛 17 | 🌐 Python | 📅 2026-09-01.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,536 | 🐛 390 | 🌐 TypeScript | 📅 2026-09-04 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,534 | 🐛 119 | 🌐 HTML | 📅 2026-08-25 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,189 | 🐛 588 | 🌐 C++ | 📅 2026-09-04 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,627 | 🐛 84 | 🌐 C | 📅 2026-09-04 - A fast image processing library with low memory needs.
...
* [Photon](https://github.com/komoot/photon) ⭐ 3,025 | 🐛 43 | 🌐 Java | 📅 2026-09-04 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,663 | 🐛 1,656 | 🌐 JavaScript | 📅 2026-09-04 - An open-source JavaScript library for world-class 3D globes and maps.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,173 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-04 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,556 | 🐛 486 | 🌐 TypeScript | 📅 2026-09-04 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,345 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,242 | 🐛 422 | 🌐 Python | 📅 2026-09-03 - Python tools for geographic data
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 54 | 🌐 Python | 📅 2026-09-04 - python interface to PROJ4 library for cartographic transformations
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,443 | 🐛 69 | 🌐 R | 📅 2026-08-21 - Simple Features for R
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,889 | 🐛 55 | 🌐 Rust | 📅 2026-09-04 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,924 | 🐛 130 | 🌐 Rust | 📅 2026-09-01 - Geospatial primitives and algorithms for Rust.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,512 | 🐛 68 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,277 | 🐛 2 | 📅 2026-09-03 - most Geospatial Library content come from this ropository.

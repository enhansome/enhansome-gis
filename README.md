...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,217 | 🐛 22 | 🌐 Python | 📅 2026-09-01.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 495 | 🐛 557 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 249 | 🌐 Scala | 📅 2026-09-10 - A geographic data processing engine for high performance applications that uses Spark to work with raster data.
...
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,536 | 🐛 119 | 🌐 HTML | 📅 2026-08-25 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [three-geo](https://github.com/w3reality/three-geo) ⭐ 1,409 | 🐛 28 | 🌐 JavaScript | 📅 2025-02-25 - Is a three.js based geographic visualization library
...
* [d3-carto-map](https://github.com/emeeks/d3-carto-map) ⭐ 279 | 🐛 20 | 🌐 JavaScript | 📅 2015-03-15 - A library for creating layer-based maps using D3
...
* [MBtiles](https://github.com/mapbox/mbtiles-spec) ⭐ 671 | 🐛 19 | 📅 2026-06-29 - A specification for storing tiled map data in SQLite databases
...
* **Cross-Platform**
  * [Red Grid MGRS](https://github.com/RedGridTactical/RedGridMGRS) ⭐ 20 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-09 - Open-source DAGR-class military GPS navigator with live MGRS coordinates, magnetic declination, waypoints, bearing & distance, and tactical tools. Built with React Native/Expo for iOS and Android.
...
* [deep learning object detection](https://github.com/hoya012/deep_learning_object_detection) ⭐ 11,382 | 🐛 5 | 🌐 Python | 📅 2024-02-12 - A paper list of object detection using deep learning.
* [Awesome Semantic Segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,846 | 🐛 17 | 📅 2021-05-08 - A code list of semantic segmentation.
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,326 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,326 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,201 | 🐛 606 | 🌐 C++ | 📅 2026-09-12 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,634 | 🐛 82 | 🌐 C | 📅 2026-09-12 - A fast image processing library with low memory needs.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,196 | 🐛 942 | 🌐 C++ | 📅 2026-09-11 - Open Source Routing Engine for OpenStreetMap.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 20 | 🌐 Go | 📅 2026-03-30 - Package orb defines a set of types for working with 2d geo and planar/projected geometric data in Golang.
...
* [Go.Geo](https://github.com/paulmach/go.geo) ⭐ 340 | 🐛 4 | 🌐 Go | 📅 2018-09-12 - Geometry/geography library in Go.
...
* [Photon](https://github.com/komoot/photon) ⭐ 3,048 | 🐛 46 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,720 | 🐛 1,665 | 🌐 JavaScript | 📅 2026-09-12 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,582 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-11 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,646 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,175 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-09 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
* [gcoord](https://github.com/hujiulong/gcoord) ⭐ 3,320 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-23 - 地理坐标系转换工具，支持WGS84/GCJ02/BD09等常用坐标系互转.
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,913 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - A Vue 2.x & Vue 3.x based component library of CesiumJS for GISer.
...
* [leaflet-geoserver-request](https://github.com/iamtekson/leaflet-geoserver-request) ⭐ 204 | 🐛 4 | 🌐 JavaScript | 📅 2023-07-05 - This is the small library which helps to connect geoserver with leaflet. Using this library, we can make WMS, WFS, getLegendGraphic, WMS-Image request.
...
* [osm-static-maps](https://github.com/jperelli/osm-static-maps) ⭐ 181 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-06 - Openstreetmap static maps is a nodejs lib, CLI and server to create map images based on tiles + layers. Inspired on google static map service.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 11 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-12 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [GeoStats.jl](https://github.com/juliohm/GeoStats.jl) ⭐ 591 | 🐛 5 | 🌐 Julia | 📅 2026-09-10 - Geostatistics in Julia.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,582 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-11 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,372 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,840 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,245 | 🐛 420 | 🌐 Python | 📅 2026-09-12 - Python tools for geographic data
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,505 | 🐛 227 | 🌐 Python | 📅 2026-09-12 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,572 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - A library for reads and writes geospatial raster data)
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,911 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 50 | 🌐 Python | 📅 2026-09-09 - python interface to PROJ4 library for cartographic transformations
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 80 | 🌐 Python | 📅 2026-09-09 - Raster-Based Spatial Analysis in Python.
...
* [Rtree](https://github.com/Toblerity/Rtree) ⭐ 682 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - A wrapper of libspatialindex providing spatial indexing features for Python GIS.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 648 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,203 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 350 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Easily visualize large geospatial images with ipyleaflet or folium in Jupyter or in a web browser with CesiumJS.
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,203 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [morecantile](https://github.com/developmentseed/morecantile) ⭐ 161 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - Construct and use map tile grids (a.k.a TileMatrixSet / TMS).
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 188 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,203 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,930 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,203 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
* [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 449 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 346 | 🐛 22 | 🌐 Rust | 📅 2026-04-29 - Library for serializing the GeoJSON vector GIS file format.
* [Hecate](https://github.com/mapbox/Hecate) ⚠️ Archived - Fast Geospatial Feature Storage API.
* [rust-proj](https://github.com/georust/rust-proj) ⭐ 185 | 🐛 40 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
...
* [rust-wkt](https://github.com/georust/rust-wkt) ⭐ 56 | 🐛 18 | 🌐 Rust | 📅 2026-09-10 - Rust read/write support for well-known text (WKT).
...
* [Mapbox Vector Tile](https://github.com/mapbox/vector-tile-spec) ⭐ 1,010 | 🐛 46 | 📅 2026-06-29
...
* [Phantom Tide](https://github.com/tg12/phantomtide) ⭐ 123 | 🐛 4 | 📅 2026-08-18 - Real-time geospatial intelligence platform for maritime and airspace monitoring, combining vessel tracking, ADS-B flight activity, official notices, environmental context, and satellite detections in a single live map workflow.
...
* [Awesome-GEE](https://github.com/giswqs/Awesome-GEE) ⭐ 1,241 | 🐛 0 | 📅 2026-08-31 - A curated list of Google Earth Engine resources.
...
* [awesome-qgis](https://github.com/totpero/awesome-qgis) ⭐ 33 | 🐛 0 | 📅 2026-08-27 - An awesome list that curates the best QGis frameworks, libraries, tools, plugins, tutorials, articles,resources and more.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,281 | 🐛 0 | 📅 2026-09-11 - most Geospatial Library content come from this ropository.

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,713 | 🐛 26 | 🌐 Python | 📅 2026-09-18.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,701 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [three-geo](https://github.com/w3reality/three-geo) ⭐ 1,412 | 🐛 28 | 🌐 JavaScript | 📅 2025-02-25 - Is a three.js based geographic visualization library
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,335 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,335 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,217 | 🐛 609 | 🌐 C++ | 📅 2026-09-19 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,655 | 🐛 78 | 🌐 C | 📅 2026-09-19 - A fast image processing library with low memory needs.
...
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,479 | 🐛 111 | 🌐 Python | 📅 2026-09-16 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,227 | 🐛 941 | 🌐 C++ | 📅 2026-09-19 - Open Source Routing Engine for OpenStreetMap.
...
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,665 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,954 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-15 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,597 | 🐛 544 | 🌐 TypeScript | 📅 2026-09-19 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,398 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,846 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,253 | 🐛 418 | 🌐 Python | 📅 2026-09-19 - Python tools for geographic data
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,512 | 🐛 228 | 🌐 Python | 📅 2026-09-19 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,919 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,927 | 🐛 51 | 🌐 Rust | 📅 2026-09-19 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,938 | 🐛 134 | 🌐 Rust | 📅 2026-09-19 - Geospatial primitives and algorithms for Rust.
...
* [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 452 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
...
* [awesome-arcgis-developers](https://github.com/Esri/awesome-arcgis-developers) ⭐ 330 | 🐛 10 | 📅 2026-04-14- A curated list of resources to help you with ArcGIS development.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,527 | 🐛 72 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,292 | 🐛 2 | 📅 2026-09-19 - most Geospatial Library content come from this ropository.

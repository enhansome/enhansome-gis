...
Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,012 | 🐛 22 | 🌐 Python | 📅 2026-09-01.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,197 | 🐛 606 | 🌐 C++ | 📅 2026-09-11 - A fork of mapbox-gl-native after licensing change
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,602 | 🐛 784 | 🌐 C++ | 📅 2026-09-11 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,686 | 🐛 242 | 🌐 Java | 📅 2026-09-11 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
...
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,578 | 🐛 526 | 🌐 TypeScript | 📅 2026-09-11 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,641 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,365 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,578 | 🐛 526 | 🌐 TypeScript | 📅 2026-09-11 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,371 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,840 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,503 | 🐛 230 | 🌐 Python | 📅 2026-09-10 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,909 | 🐛 48 | 🌐 Rust | 📅 2026-09-11 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 215 | 🌐 Swift | 📅 2026-09-11 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,280 | 🐛 0 | 📅 2026-09-11 - most Geospatial Library content come from this ropository.

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 317,707 | 🐛 16 | 🌐 Python | 📅 2026-09-01.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 494 | 🐛 556 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,373 | 🐛 250 | 🌐 Scala | 📅 2026-08-11 - A geographic data processing engine for high performance applications that uses Spark to work with raster data.
* [Nanocubes](http://www.nanocubes.net/) - An in-memory data structure for spatiotemporal data cubes. [Github Link](https://github.com/laurolins/nanocube) ⭐ 733 | 🐛 42 | 🌐 C | 📅 2023-05-04
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,505 | 🐛 389 | 🌐 TypeScript | 📅 2026-09-01 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,533 | 🐛 118 | 🌐 HTML | 📅 2026-08-25 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [three-geo](https://github.com/w3reality/three-geo) ⭐ 1,405 | 🐛 28 | 🌐 JavaScript | 📅 2025-02-25 - Is a three.js based geographic visualization library
...
* [d3-carto-map](https://github.com/emeeks/d3-carto-map) ⭐ 278 | 🐛 20 | 🌐 JavaScript | 📅 2015-03-15 - A library for creating layer-based maps using D3
...
* **Cross-Platform**
  * [Red Grid MGRS](https://github.com/RedGridTactical/RedGridMGRS) ⭐ 19 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-28 - Open-source DAGR-class military GPS navigator with live MGRS coordinates, magnetic declination, waypoints, bearing & distance, and tactical tools. Built with React Native/Expo for iOS and Android.
...
* [deep learning object detection](https://github.com/hoya012/deep_learning_object_detection) ⭐ 11,384 | 🐛 5 | 🌐 Python | 📅 2024-02-12 - A paper list of object detection using deep learning.
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,315 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,315 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,179 | 🐛 581 | 🌐 C++ | 📅 2026-09-01 - A fork of mapbox-gl-native after licensing change
...
* [H3](https://github.com/uber/h3) ⭐ 6,515 | 🐛 164 | 🌐 C | 📅 2026-09-01 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,595 | 🐛 778 | 🌐 C++ | 📅 2026-09-01 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,439 | 🐛 114 | 🌐 Python | 📅 2026-09-01 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,147 | 🐛 940 | 🌐 C++ | 📅 2026-08-31 - Open Source Routing Engine for OpenStreetMap.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,714 | 🐛 56 | 🌐 C# | 📅 2026-09-01 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [DEM Net Elevation API](https://github.com/dem-net/DEM.Net) ⭐ 355 | 🐛 18 | 🌐 C# | 📅 2026-04-18 - Library focused on Digital Elevation Models, OSM and 3D from open data. Playground: <https://elevationapi.com>
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,128 | 🐛 19 | 🌐 Go | 📅 2026-03-30 - Package orb defines a set of types for working with 2d geo and planar/projected geometric data in Golang.
...
* [Photon](https://github.com/komoot/photon) ⭐ 3,016 | 🐛 43 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,635 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-09-01 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,544 | 🐛 488 | 🌐 TypeScript | 📅 2026-09-01 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,590 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,172 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-31 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,911 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - A Vue 2.x & Vue 3.x based component library of CesiumJS for GISer.
...
* [osm-static-maps](https://github.com/jperelli/osm-static-maps) ⭐ 181 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-25 - Openstreetmap static maps is a nodejs lib, CLI and server to create map images based on tiles + layers. Inspired on google static map service.
...
* [GeoStats.jl](https://github.com/juliohm/GeoStats.jl) ⭐ 591 | 🐛 5 | 🌐 Julia | 📅 2026-08-27 - Geostatistics in Julia.
...
* [Laravel Magellan](https://github.com/clickbar/laravel-magellan) ⭐ 443 | 🐛 1 | 🌐 PHP | 📅 2026-06-23 - A modern PostGIS integration for Laravel 9+, including parsers and generators.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,544 | 🐛 488 | 🌐 TypeScript | 📅 2026-09-01 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,335 | 🐛 320 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,837 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,496 | 🐛 238 | 🌐 Python | 📅 2026-08-20 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,022 | 🐛 52 | 🌐 Python | 📅 2026-09-01 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,567 | 🐛 157 | 🌐 Python | 📅 2026-09-01 - A library for reads and writes geospatial raster data)
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,897 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,222 | 🐛 58 | 🌐 Python | 📅 2026-08-21 - python interface to PROJ4 library for cartographic transformations
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 969 | 🐛 81 | 🌐 Python | 📅 2026-08-27 - Raster-Based Spatial Analysis in Python.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 616 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 592 | 🐛 18 | 🌐 Python | 📅 2026-09-01 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 350 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - Easily visualize large geospatial images with ipyleaflet or folium in Jupyter or in a web browser with CesiumJS.
...
* [WaterDetect](https://github.com/cordmaur/WaterDetect) ⭐ 221 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-05-10 - An end-to-end algorithm to generate open water cover mask.
...
* [morecantile](https://github.com/developmentseed/morecantile) ⭐ 161 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - Construct and use map tile grids (a.k.a TileMatrixSet / TMS).
...
* [geojson-shave](https://github.com/ben-nour/geojson-shave) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - a Python command-line tool for reducing the size of GeoJSON files.
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,920 | 🐛 123 | 🌐 Rust | 📅 2026-09-01 - Geospatial primitives and algorithms for Rust.
...
* [rust-proj](https://github.com/georust/rust-proj) ⭐ 185 | 🐛 39 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
...
* [Mapbox Vector Tile](https://github.com/mapbox/vector-tile-spec) ⭐ 1,007 | 🐛 46 | 📅 2026-06-29
...
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,380 | 🐛 6 | 🌐 HTML | 📅 2026-05-13 - curated list of awesome tools, tutorials, code, helpful projects, links, stuff about Earth Observation and Geospatial stuff!
* [Awesome-GEE](https://github.com/giswqs/Awesome-GEE) ⭐ 1,238 | 🐛 0 | 📅 2026-08-31 - A curated list of Google Earth Engine resources.
...
* [awesome-qgis](https://github.com/totpero/awesome-qgis) ⭐ 32 | 🐛 0 | 📅 2026-08-27 - An awesome list that curates the best QGis frameworks, libraries, tools, plugins, tutorials, articles,resources and more.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,275 | 🐛 1 | 📅 2026-09-01 - most Geospatial Library content come from this ropository.

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,901 | 🐛 19 | 🌐 Python | 📅 2026-09-20.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,375 | 🐛 243 | 🌐 Scala | 📅 2026-09-14 - A geographic data processing engine for high performance applications that uses Spark to work with raster data.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,706 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,337 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,337 | 🐛 2 | 📅 2026-09-09 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,217 | 🐛 606 | 🌐 C++ | 📅 2026-09-20 - A fork of mapbox-gl-native after licensing change
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,231 | 🐛 940 | 🌐 C++ | 📅 2026-09-20 - Open Source Routing Engine for OpenStreetMap.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,757 | 🐛 1,660 | 🌐 JavaScript | 📅 2026-09-18 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,598 | 🐛 542 | 🌐 TypeScript | 📅 2026-09-20 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,666 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,180 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-20 - Tools for editing Shapefile, GeoJSON, TopoJSON and CSV files.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,598 | 🐛 542 | 🌐 TypeScript | 📅 2026-09-20 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,400 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,848 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,255 | 🐛 418 | 🌐 Python | 📅 2026-09-19 - Python tools for geographic data
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,511 | 🐛 229 | 🌐 Python | 📅 2026-09-19 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,922 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 972 | 🐛 79 | 🌐 Python | 📅 2026-09-09 - Raster-Based Spatial Analysis in Python.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 657 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,939 | 🐛 134 | 🌐 Rust | 📅 2026-09-19 - Geospatial primitives and algorithms for Rust.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,375 | 🐛 243 | 🌐 Scala | 📅 2026-09-14 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
...
* [awesome-arcgis-developers](https://github.com/Esri/awesome-arcgis-developers) ⭐ 330 | 🐛 11 | 📅 2026-04-14- A curated list of resources to help you with ArcGIS development.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,530 | 🐛 73 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,293 | 🐛 5 | 📅 2026-09-19 - most Geospatial Library content come from this ropository.

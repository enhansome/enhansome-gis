...
Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 319,323 | 🐛 20 | 🌐 Python | 📅 2026-09-01.
...
* **Cross-Platform**
  * [Red Grid MGRS](https://github.com/RedGridTactical/RedGridMGRS) ⭐ 19 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 - Open-source DAGR-class military GPS navigator with live MGRS coordinates, magnetic declination, waypoints, bearing & distance, and tactical tools. Built with React Native/Expo for iOS and Android.
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,324 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, papers, and contests related to remote sensing change detection.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,324 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,194 | 🐛 608 | 🌐 C++ | 📅 2026-09-08 - A fork of mapbox-gl-native after licensing change
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,689 | 🐛 1,660 | 🌐 JavaScript | 📅 2026-09-08 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,564 | 🐛 510 | 🌐 TypeScript | 📅 2026-09-08 - WebGL2 powered geospatial visualization layers.
* [city-roads](https://github.com/anvaka/city-roads) ⭐ 9,618 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Visualization of all roads within any city.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,944 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,564 | 🐛 510 | 🌐 TypeScript | 📅 2026-09-08 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,359 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,500 | 🐛 240 | 🌐 Python | 📅 2026-09-08 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,909 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [Pyproj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 50 | 🌐 Python | 📅 2026-09-07 - python interface to PROJ4 library for cartographic transformations
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 89 | 🌐 Python | 📅 2026-09-04 - Raster-Based Spatial Analysis in Python.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 628 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,897 | 🐛 52 | 🌐 Rust | 📅 2026-09-08 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,279 | 🐛 2 | 📅 2026-09-08 - most Geospatial Library content come from this ropository.

...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,746 | 🐛 21 | 🌐 Python | 📅 2026-09-23.
...
* [OpenOrienteering Mapper](https://github.com/openorienteering/mapper) ⭐ 497 | 🐛 561 | 🌐 C++ | 📅 2026-07-21 - A software for creating maps for the orienteering sport.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,224 | 🐛 610 | 🌐 C++ | 📅 2026-09-24 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,673 | 🐛 78 | 🌐 C | 📅 2026-09-24 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,559 | 🐛 168 | 🌐 C | 📅 2026-09-18 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,611 | 🐛 769 | 🌐 C++ | 📅 2026-09-24 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,249 | 🐛 938 | 🌐 C++ | 📅 2026-09-23 - Open Source Routing Engine for OpenStreetMap.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,704 | 🐛 241 | 🌐 Java | 📅 2026-09-24 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,770 | 🐛 1,685 | 🌐 JavaScript | 📅 2026-09-24 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,611 | 🐛 548 | 🌐 TypeScript | 📅 2026-09-24 - WebGL2 powered geospatial visualization layers.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,611 | 🐛 548 | 🌐 TypeScript | 📅 2026-09-24 - High-scale spatial rendering in Python, powered by deck.gl.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,577 | 🐛 157 | 🌐 Python | 📅 2026-09-23 - A library for reads and writes geospatial raster data)
...
* [Rtree](https://github.com/Toblerity/Rtree) ⭐ 683 | 🐛 26 | 🌐 Python | 📅 2026-09-24 - A wrapper of libspatialindex providing spatial indexing features for Python GIS.
...
* [Prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 14 | 🌐 R | 📅 2026-09-24 - The prioritizr R package uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,536 | 🐛 78 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,297 | 🐛 4 | 📅 2026-09-23 - most Geospatial Library content come from this ropository.

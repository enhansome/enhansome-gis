...
[![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/stargazers) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21
[![GitHub forks](https://img.shields.io/github/forks/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/network) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21
...
[![GitHub license](https://img.shields.io/github/license/sshuair/awesome-gis)](https://github.com/sshuair/awesome-gis/blob/master/LICENSE) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21

Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.

**Please contribute. Let's make this guide better!** Please follow the [Contributing Guidelines](https://github.com/sshuair/awesome-gis/blob/master/ContributingGuidelines.md) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21. Or you can comment below this issue: [Welcome to contribute](https://github.com/sshuair/awesome-gis/issues/72) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21

Inspired by [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 314,644 | 🐛 17 | 🌐 Python | 📅 2026-08-16.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,375 | 🐛 391 | 🌐 TypeScript | 📅 2026-08-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license
* [maptalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,530 | 🐛 117 | 🌐 HTML | 📅 2026-08-18 - A light and plugable JavaScript library for integrated 2D/3D maps.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,714 | 🐛 163 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
...
* [Awesome Remote Sensing Change Detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,301 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, papers, and contests related to remote sensing change detection.
* [rastervision](https://github.com/azavea/raster-vision) ⭐ 2,239 | 🐛 45 | 🌐 Python | 📅 2026-06-04 - An open source framework for deep learning on satellite and aerial imagery.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,301 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, researchers and contests related to remote sensing change detection.
...
* [maplibre-gl-native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,148 | 🐛 565 | 🌐 C++ | 📅 2026-08-18 - A fork of mapbox-gl-native after licensing change
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,576 | 🐛 81 | 🌐 C | 📅 2026-08-18 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,469 | 🐛 165 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,583 | 🐛 763 | 🌐 C++ | 📅 2026-08-18 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,079 | 🐛 932 | 🌐 C++ | 📅 2026-08-18 - Open Source Routing Engine for OpenStreetMap.
...
* [Photon](https://github.com/komoot/photon) ⭐ 2,995 | 🐛 43 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,577 | 🐛 1,640 | 🌐 JavaScript | 📅 2026-08-18 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,467 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-18 - WebGL2 powered geospatial visualization layers.
...
* [pydeck](https://github.com/visgl/deck.gl/tree/master/bindings/pydeck) ⭐ 14,467 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-18 - High-scale spatial rendering in Python, powered by deck.gl.
* [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,300 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - A blender addons to make the bridge between Blender and geographic data.
* [OSMnx](https://github.com/gboeing/osmnx) ⭐ 5,815 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - Python package that lets you download spatial geometries and construct, project, visualize, and analyze street networks from OpenStreetMap's APIs.
...
* [Shapely](https://github.com/Toblerity/Shapely) ⭐ 4,488 | 🐛 237 | 🌐 Python | 📅 2026-08-12 - A library for manipulation and analysis of geometric objects in the Cartesian plane.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,014 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,561 | 🐛 156 | 🌐 Python | 📅 2026-08-18 - A library for reads and writes geospatial raster data)
* [felicette](https://github.com/plant99/felicette) ⚠️ Archived - Satellite imagery for dummies.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,470 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python library for converting geospatial datasets into graphs (networks) for geospatial network analysis and GeoAI with GNNs (Graph Neural Networks).
...
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 963 | 🐛 85 | 🌐 Python | 📅 2026-08-17 - Raster-Based Spatial Analysis in Python.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 600 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Renders interactive maps automatically.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,836 | 🐛 74 | 🌐 Rust | 📅 2026-08-18 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [rust-geo](https://github.com/georust/rust-geo) ⭐ 1,913 | 🐛 117 | 🌐 Rust | 📅 2026-08-18 - Geospatial primitives and algorithms for Rust.
...
* [rust-proj](https://github.com/georust/rust-proj) ⭐ 183 | 🐛 39 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
* [rust-gpx](https://github.com/georust/rust-gpx) ⭐ 122 | 🐛 5 | 🌐 Rust | 📅 2025-08-19 - Rust read/write support for GPS Exchange Format (GPX).
* [rust-geohash](https://github.com/georust/rust-geohash) ⭐ 120 | 🐛 5 | 🌐 Rust | 📅 2026-06-14 - Geohash for Rust.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - An open-source fuel & EV route planner using PostGIS, MapLibre GL JS, Valhalla, and Photon. Covers 36 countries with real-time pricing and is self-hostable.
...
* [Geospatial Start-ups And Companies list](https://github.com/sshuair/awesome-gis/blob/master/Geospatial-Start-ups-And-Companies.md) ⭐ 5,483 | 🐛 58 | 📅 2026-07-21
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,257 | 🐛 1 | 📅 2026-08-18 - most Geospatial Library content come from this ropository.
